...
$string['prefixhelp'] = 'Le préfixe est ici utile si le serveur Red5 est utilisé pour le traitement d\'autres contenus. Il vous sera alors possible d\'identifier aisément les flux audio et vidéos enregistrés. ';
...
$string['secondsRefreshClassmonitorhelp'] = 'Inscrire le nombre de microsecondes entre les mises à jour automatiques de la liste d\'étudiants du moniteur de classe';
$string['secondsRefreshHistory'] = 'Nombre de microsecondes avant la prochaine mise à jour automatique de l\'historique';
$string['secondsRefreshHistoryhelp'] = 'Inscrire le nombre de microsecondes entre les mises à jour automatiques des enregistrements';
$string['secondsRefreshStudentView'] = 'Nombre de microsecondes avant la prochaine mise à jour automatique des étudiants';
$string['secondsRefreshStudentViewhelp'] = 'Inscrire le nombre de microsecondes entre les mises à jour automatiques des étudiants. Utilisé pour le flux en direct';
